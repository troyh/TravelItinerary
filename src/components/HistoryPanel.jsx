...
export default function HistoryPanel({ settings, currentFile, onRestore, onClose }) {
  ...
  return (
    <div style={{ margin: ".75rem 0 1rem", padding: "1rem 1.25rem", background: "#0a1a2a",
      ...
      {loading && (
        <div style={{ color: "#4e7a9e", fontFamily: "sans-serif", fontSize: ".82rem" }}>Loading…</div>
      )}
      {error && (
        <div style={{ color: "#e87878", fontFamily: "sans-serif", fontSize: ".78rem" }}>{error}</div>
      )}
          ...
          <div key={c.sha}
            ...
            <div style={{ display: "flex", justifyContent: "space-between",
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: ".78rem", color: "#c8daea", fontFamily: "sans-serif",
                  lineHeight: 1.4 }}>
                  {c.message}
                </div>
              </div>
